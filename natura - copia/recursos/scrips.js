...
// ================== IMÁGENES (solo .webp) ==================
const IMG_EXTS = ["webp"]; // Todas las imágenes auxiliares se esperan en .webp
...
// Nueva lógica: cada producto usa SOLO codigo.webp (por ejemplo 123.webp)
...
cartList.addEventListener("click", e => {
  const btn = e.target.closest("remove-item-btn") || e.target.closest(".remove-item-btn");
  if (!btn) return;
...
// Fondo dinámico con logo_natura (formato .webp)
