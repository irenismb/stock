...
(() => {
  ...
  function productIsHidden(product){
    ...
    const family = norm(product.fragranceFamily);
    ...
    if(!row){
      ...
      row.innerHTML = `
        <div>
          ...
          <span class="catalog-admin-config-help">Filtro exclusivo del modo administrador. Al activarlo no muestra secciones, categorías, subcategorías, familias ni productos marcados como ocultos. No cambia ni elimina su estado de visibilidad.</span>
        </div>
